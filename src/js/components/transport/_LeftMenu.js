...
import { currentMenuTransp } from 'Actions/_actionTransp';
            ...
            <div className="leftMenu" style={width}>
                <div className="menuFilters">
                    ...
                    <Collapse in={this.state.collapseFilters}>
                        <Nav bsStyle="pills">
                            <NavItem eventKey={1} href="#" className={this.props.transp.left_menu.filter1} onClick={this.hendleMenu.bind(this, 'toMyWg', 0)}><i className={this.state.iconFilter1}></i>{' '}{this.state.nameFilter1}</NavItem>
                            <NavItem eventKey={2} href="#" className={this.props.transp.left_menu.filter2} onClick={this.hendleMenu.bind(this, 'toMy', 1)}><i className={this.state.iconFilter2}></i>{' '}{this.state.nameFilter2}</NavItem>
                            <NavItem eventKey={6} href="#" className={this.props.transp.left_menu.filter6} onClick={this.hendleMenu.bind(this, 'newOrders', 5)}><i className={this.state.iconFilter6}></i>{' '}{this.state.nameFilter6}</NavItem>
                            <NavItem eventKey={7} href="#" className={this.props.transp.left_menu.filter7} onClick={this.hendleMenu.bind(this, 'carAppointed', 6)}><i className={this.state.iconFilter7}></i>{' '}{this.state.nameFilter7}</NavItem>
                            <NavItem eventKey={3} href="#" className={this.props.transp.left_menu.filter3} onClick={this.hendleMenu.bind(this, 'doneTrip', 2)}><i className={this.state.iconFilter3}></i>{' '}{this.state.nameFilter3}</NavItem>
                            {/* <NavItem eventKey={4} href="#" onClick={this.props.dataSend}><i className={this.state.iconFilter4}></i>{' '}{this.state.nameFilter4}</NavItem> */}
                            <NavItem eventKey={5} href="#" className={this.props.transp.left_menu.filter5} onClick={this.hendleMenu.bind(this, 'cancelClient', 4)}><i className={this.state.iconFilter5}></i>{' '}{this.state.nameFilter5}</NavItem>
                        </Nav>
                    </Collapse>
                </div>
                <div className="menuDirectory">
                    ...
                    <Collapse in={this.state.collapseDirectories}>
                        <Nav bsStyle="pills">
                            <NavItem eventKey={1} href="#" className={this.props.transp.left_menu.filter8} onClick={this.hendleMenu.bind(this, 'drivers', 7)}><i className={this.state.iconDirectory1}></i>{' '}{this.state.nameDirectory1}</NavItem>
                            <NavItem eventKey={2} href="#" className={this.props.transp.left_menu.filter9} onClick={this.hendleMenu.bind(this, 'cars', 8)}><i className={this.state.iconDirectory2}></i>{' '}{this.state.nameDirectory2}</NavItem>
                        </Nav>
                    </Collapse>
                </div>
                <label>
...
export default connect(
    ...
    dispatch => ({
        currentMenu: (value) => {
            dispatch(currentMenuTransp(value));
        },
        activeFilter: (num) => {
